// chart-utilities.js
// These are utility functions extracted from the waistline chart component
// that handle data processing but aren't directly tied to rendering rectangles
import * as d3 from 'd3';
/**
 * Filters ASTM data based on provided filters
 * @param {Array} ASTMsizes - The full ASTM dataset
 * @param {Object} filters - Filters to apply (year, sizeRange)
 * @returns {Array} Filtered ASTM data
 */

<script>
    ...
    import { getFilteredWaistlineData, getFilteredASTMData, getUniqueOptions, filterMatchingASTMSizes, sizeBackgroundColors, getSizeBackgrounds } from "./Filters.js"
    import { ASTMFilters, waistlineFilters } from "./stores.js";

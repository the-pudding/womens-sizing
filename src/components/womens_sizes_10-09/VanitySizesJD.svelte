...
</script>text: <p>Today, that gap is 15.2 inches between the smallest size 00 (25.38 inches) and the largest size (40 inches)</p><p>While additional sizes for 00 and 0 were added in the early 2000s, all waistline measurements today are larger regardless of size. </p>
        ...
        <div class="subtitle">
            {#if block.subhed}
                <h3>
                    ...
                    <Ransom string="sizing" />text: <p>Today, that gap is 15.2 inches between the smallest size 00 (25.38 inches) and the largest size (40 inches)</p><p>While additional sizes for 00 and 0 were added in the early 2000s, all waistline measurements today are larger regardless of size. </p>

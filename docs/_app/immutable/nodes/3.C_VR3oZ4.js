import"../chunks/Bzak7iHL.js";import{h as B,a as ve,f as se,aE as Be,b as Ue,E as je,d as Le,aF as Pe,af as Ne,ad as We,c as Oe,a3 as ye,a2 as we,D as qe,p as He,a5 as Je,ag as Xe,V as _,X as p,ax as z,Z as b,_ as y,ay as I,aw as T,aA as $e,W as A,A as i,az as U,C as D,av as j,aG as Ge,U as Z,Y as K,u as pe,aH as Ve,R as ke,B as Ye}from"../chunks/Dzm_WEGj.js";import{i as Ze,b as be,a as C,d as Ke}from"../chunks/ZgVi19R2.js";import{b as ze,c as xe,e as q,i as H,d as Qe,s as en,f as nn,g as tn}from"../chunks/CbB6GLjC.js";import{c as le}from"../chunks/DH1QYJyw.js";import{s as he,p as Y}from"../chunks/ihUrmXYw.js";import{S as an,h as _e,c as sn}from"../chunks/Ctsf2R2B.js";import{i as O}from"../chunks/C0w0nz2X.js";import{s as rn}from"../chunks/BIhypZ3Q.js";import{b as on}from"../chunks/C6CwkwJm.js";function de(e,n,a,s,o,h){let u=B;B&&ve();var m,v,r=null;B&&se.nodeType===Be&&(r=se,ve());var c=B?se:e,t,l=xe;Ue(()=>{const f=n()||null;var g=f==="svg"?Pe:null;if(f!==m){var d=xe;ze(l),t&&(f===null?He(t,()=>{t=null,v=null}):f===v?Je(t):(Xe(t),be(!1))),f&&f!==v&&(t=Le(()=>{if(r=B?r:g?document.createElementNS(g,f):document.createElement(f),Ne(r,r),s){B&&Ze(f)&&r.append(document.createComment(""));var w=B?We(r):r.appendChild(Oe());B&&(w===null?ye(!1):we(w)),s(r,w)}qe.nodes_end=r,c.before(r)})),m=f,m&&(v=m),be(!0),ze(d)}},je),u&&(ye(!0),we(c))}var Te={},re={},oe=34,V=10,ie=13;function Re(e){return new Function("d","return {"+e.map(function(n,a){return JSON.stringify(n)+": d["+a+'] || ""'}).join(",")+"}")}function ln(e,n){var a=Re(e);return function(s,o){return n(a(s),o,e)}}function Se(e){var n=Object.create(null),a=[];return e.forEach(function(s){for(var o in s)o in n||a.push(n[o]=o)}),a}function R(e,n){var a=e+"",s=a.length;return s<n?new Array(n-s+1).join(0)+a:a}function hn(e){return e<0?"-"+R(-e,6):e>9999?"+"+R(e,6):R(e,4)}function dn(e){var n=e.getUTCHours(),a=e.getUTCMinutes(),s=e.getUTCSeconds(),o=e.getUTCMilliseconds();return isNaN(e)?"Invalid Date":hn(e.getUTCFullYear())+"-"+R(e.getUTCMonth()+1,2)+"-"+R(e.getUTCDate(),2)+(o?"T"+R(n,2)+":"+R(a,2)+":"+R(s,2)+"."+R(o,3)+"Z":s?"T"+R(n,2)+":"+R(a,2)+":"+R(s,2)+"Z":a||n?"T"+R(n,2)+":"+R(a,2)+"Z":"")}function pn(e){var n=new RegExp('["'+e+`
\r]`),a=e.charCodeAt(0);function s(t,l){var f,g,d=o(t,function(w,x){if(f)return f(w,x-1);g=w,f=l?ln(w,l):Re(w)});return d.columns=g||[],d}function o(t,l){var f=[],g=t.length,d=0,w=0,x,S=g<=0,k=!1;t.charCodeAt(g-1)===V&&--g,t.charCodeAt(g-1)===ie&&--g;function E(){if(S)return re;if(k)return k=!1,Te;var X,F=d,M;if(t.charCodeAt(F)===oe){for(;d++<g&&t.charCodeAt(d)!==oe||t.charCodeAt(++d)===oe;);return(X=d)>=g?S=!0:(M=t.charCodeAt(d++))===V?k=!0:M===ie&&(k=!0,t.charCodeAt(d)===V&&++d),t.slice(F+1,X-1).replace(/""/g,'"')}for(;d<g;){if((M=t.charCodeAt(X=d++))===V)k=!0;else if(M===ie)k=!0,t.charCodeAt(d)===V&&++d;else if(M!==a)continue;return t.slice(F,X)}return S=!0,t.slice(F,g)}for(;(x=E())!==re;){for(var J=[];x!==Te&&x!==re;)J.push(x),x=E();l&&(J=l(J,w++))==null||f.push(J)}return f}function h(t,l){return t.map(function(f){return l.map(function(g){return c(f[g])}).join(e)})}function u(t,l){return l==null&&(l=Se(t)),[l.map(c).join(e)].concat(h(t,l)).join(`
`)}function m(t,l){return l==null&&(l=Se(t)),h(t,l).join(`
`)}function v(t){return t.map(r).join(`
`)}function r(t){return t.map(c).join(e)}function c(t){return t==null?"":t instanceof Date?dn(t):n.test(t+="")?'"'+t.replace(/"/g,'""')+'"':t}return{parse:s,parseRows:o,format:u,formatBody:m,formatRows:v,formatRow:r,formatValue:c}}var cn=pn(","),un=cn.parse,mn=_('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p></section>');function gn(e){var n=mn();p(e,n)}var fn=_('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-o47y6s"/> <p>background image</p> <div class="svelte-o47y6s"></div></section>');function vn(e){var n=fn();p(e,n)}var yn=_('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function wn(e){const n=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var a=yn(),s=z(b(a),2);q(s,17,()=>n,H,(o,h)=>{let u=()=>i(h).tag,m=()=>i(h).text;var v=I(),r=T(v);de(r,u,!1,(c,t)=>{var l=$e();A(()=>C(l,m())),p(t,l)}),p(o,v)}),y(a),p(e,a)}var bn=_("<p> </p>");function zn(e,n){var a=bn(),s=b(a);y(a),A(()=>C(s,`I am component A and my favorite number is ${n.number??""}.`)),p(e,a)}var xn=_("<p> </p>");function _n(e,n){var a=xn(),s=b(a);y(a),A(()=>C(s,`I am component B and my name is ${n.name??""}.`)),p(e,a)}var Tn=_('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function Sn(e){const n={A:zn,B:_n},a=[{component:"A",number:42},{component:"B",name:"Russell"}];var s=Tn(),o=z(b(s),2);q(o,17,()=>a,H,(h,u)=>{const m=U(()=>n[i(u).component]);var v=I(),r=T(v);le(r,()=>i(m),(c,t)=>{t(c,he(()=>i(u)))}),p(h,v)}),y(s),p(e,s)}var kn=_('<div><p class="svelte-12sq0x6"> </p></div>'),Rn=_('<section id="scrolly"><h2 class="svelte-12sq0x6">Scrolly <span> </span></h2> <div class="spacer svelte-12sq0x6"></div> <!> <div class="spacer svelte-12sq0x6"></div></section>');function In(e){let n=j(void 0);var a=Rn(),s=b(a),o=z(b(s)),h=b(o,!0);y(o),y(s);var u=z(s,4);an(u,{get value(){return i(n)},set value(m){D(n,m,!0)},children:(m,v)=>{var r=I(),c=T(r);q(c,16,()=>[0,1,2,3,4],H,(t,l,f)=>{const g=U(()=>i(n)===f);var d=kn();let w;var x=b(d),S=b(x,!0);y(x),y(d),A(k=>{w=Qe(d,1,"step svelte-12sq0x6",null,w,k),C(S,l)},[()=>({active:i(g)})]),p(t,d)}),p(m,r)},$$slots:{default:!0}}),Ge(2),y(a),A(()=>C(h,i(n)||"-")),p(e,a)}const Cn=`{
...
}`;var An=_("<p><!></p>"),Mn=_("<section><!></section>");function En(e,n){Z(n,!0);let a=Y(n,"components",19,()=>({})),s=Y(n,"body",19,()=>[]);var o=I(),h=T(o);q(h,17,s,H,(u,m)=>{let v=()=>i(m).section,r=()=>i(m).content;const c=U(()=>v().toLowerCase().replace(/[^a-z0-9]/g,"")),t=U(()=>a()[v()]);var l=Mn(),f=b(l);{var g=w=>{var x=I(),S=T(x);le(S,()=>i(t),(k,E)=>{E(k,he(r))}),p(w,x)},d=w=>{var x=I(),S=T(x);q(S,17,r,H,(k,E,J,X)=>{let F=()=>i(E).type,M=()=>i(E).value;const ce=U(()=>a()[F()]),Ie=U(()=>typeof M()=="string");var ue=I(),Ce=T(ue);{var Ae=L=>{var $=I(),Q=T($);le(Q,()=>i(ce),(ee,ne)=>{ne(ee,he(M))}),p(L,$)},Me=L=>{var $=I(),Q=T($);{var ee=P=>{var N=An(),te=b(N);_e(te,M),y(N),p(P,N)},ne=P=>{var N=I(),te=T(N);{var Ee=W=>{var G=I(),ae=T(G);de(ae,F,!1,(me,ge)=>{var fe=I(),De=T(fe);_e(De,M),p(ge,fe)}),p(W,G)},Fe=W=>{var G=I(),ae=T(G);de(ae,F,!1,(me,ge)=>{nn(me,()=>({...M()}))}),p(W,G)};O(te,W=>{i(Ie)?W(Ee):W(Fe,!1)},!0)}p(P,N)};O(Q,P=>{F()==="text"?P(ee):P(ne,!1)},!0)}p(L,$)};O(Ce,L=>{i(ce)?L(Ae):L(Me,!1)})}p(k,ue)}),p(w,x)};O(f,w=>{i(t)?w(g):w(d,!1)})}y(l),A(()=>en(l,"id",i(c))),p(u,l)}),p(e,o),K()}var Fn=_('<p> </p> <progress max="100"></progress>',1);function Dn(e,n){let a=Y(n,"label",3,"A"),s=Y(n,"value",3,0);var o=Fn(),h=T(o),u=b(h,!0);y(h);var m=z(h,2);A(()=>{C(u,a()),tn(m,s())}),p(e,o)}var Bn=_('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function Un(e,n){Z(n,!0);const{body:a}=sn,s={Test:Dn};var o=Bn(),h=z(b(o),2),u=b(h),m=b(u,!0);y(u),y(h);var v=z(h,2);En(v,{get components(){return s},get body(){return a}}),y(o),A(r=>C(m,r),[()=>Cn.replace(/\t/g," ")]),p(e,o),K()}const jn=(e,n=ke)=>{var a=Ln(),s=b(a),o=b(s,!0);y(s);var h=z(s,2),u=b(h,!0);y(h),y(a),A(()=>{C(o,n().name),C(u,n().age)}),p(e,a)};var Ln=_('<div class="person svelte-1ltx6da"><p class="svelte-1ltx6da"> </p> <p class="svelte-1ltx6da"> </p></div>'),Pn=(e,n)=>Ve(n),Nn=(e,n)=>n.random(Math.floor(Math.random()*10)),Wn=_('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-1ltx6da">count++</button> <p class="svelte-1ltx6da"> </p> <p class="svelte-1ltx6da"> </p> <p class="svelte-1ltx6da"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-1ltx6da">Random</button>  <h3>Snippets</h3> <div class="people svelte-1ltx6da"></div>',1);function On(e,n){Z(n,!0),Y(n,"age",3,30);const a=[{name:"John",age:30},{name:"Jill",age:45}];let s=j(0),o=U(()=>i(s)*2),h=U(()=>i(s)*2),u=j(0);pe(()=>{D(u,i(s)*2)});var m=Wn(),v=z(T(m),4);v.__click=[Pn,s];var r=z(v,2),c=b(r);y(r);var t=z(r,2),l=b(t);y(t);var f=z(t,2),g=b(f);y(f);var d=z(f,4),w=b(d);rn(w,()=>n.children??ke),y(d);var x=z(d,4);x.__click=[Nn,n];var S=z(x,4);q(S,21,()=>a,H,(k,E)=>{jn(k,()=>i(E))}),y(S),A(()=>{C(c,`${i(s)??""} doubled is ${i(o)??""} (derived)`),C(l,`${i(s)??""} doubled is ${i(h)??""} (derived by)`),C(g,`${i(s)??""} doubled is ${i(u)??""} ($effect)`)}),p(e,m),K()}Ke(["click"]);const qn=(e,n)=>{let a=j(Ye(e)),s=j(null),o=j(!0),h=j(void 0);const u=(r=!0)=>{D(o,r,!0),r===!0&&(D(h,null),D(s,null))},m=async()=>{try{const r=await fetch(i(a),n);if(!r.ok)throw new Error(`Unexpected error occurred (status ${r.status})`);let c;if(i(a).includes(".csv")){const t=await r.text();c=un(t)}else c=await r.json();return[null,c]}catch(r){const{errorMessage:c="Unexpected error eccurred"}=r;return[c,null]}},v=async r=>{u(!0);const[c,t]=await m();if(r===i(a)){if(c){u(!1),D(h,c,!0);return}u(!1),D(s,t,!0)}};return pe(()=>{v(i(a))}),{get data(){return i(s)},get loading(){return i(o)},get error(){return i(h)},get url(){return i(a)},set url(r){i(a)!==r&&D(a,r,!0)}}};var Hn=_("<p>loading data...</p>"),Jn=_("<p> </p>"),Xn=_("<p>data loaded</p> <pre> </pre>",1),$n=_('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Gn(e,n){Z(n,!0);const a=`${on}/assets/demo/test.csv`,s=qn(a);pe(()=>{});var o=$n(),h=z(b(o),2),u=b(h);{var m=r=>{var c=Hn();p(r,c)},v=r=>{var c=I(),t=T(c);{var l=g=>{var d=Jn(),w=b(d);y(d),A(()=>C(w,`error: ${s.error??""}`)),p(g,d)},f=g=>{var d=Xn(),w=z(T(d),2),x=b(w,!0);y(w),A(S=>C(x,S),[()=>JSON.stringify(s.data,null,2)]),p(g,d)};O(t,g=>{s.error?g(l):g(f,!1)},!0)}p(r,c)};O(u,r=>{s.loading?r(m):r(v,!1)})}y(h),y(o),p(e,o),K()}var Vn=_('<div id="demo" class="svelte-m1ilu3"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function Yn(e){let n=j(0);function a(l){console.log(l)}var s=Vn(),o=z(b(s),2);On(o,{random:a,get value(){return i(n)},set value(l){D(n,l,!0)}});var h=z(o,2);gn(h);var u=z(h,2);vn(u);var m=z(u,2);wn(m);var v=z(m,2);Sn(v);var r=z(v,2);Un(r,{});var c=z(r,2);Gn(c,{});var t=z(c,2);In(t),y(s),p(e,s)}function it(e){Yn(e)}export{it as component};

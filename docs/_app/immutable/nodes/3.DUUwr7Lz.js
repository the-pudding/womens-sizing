...
`)}function r(t){return t.map(u).join(e)}function u(t){return t==null?"":t instanceof Date?dn(t):n.test(t+="")?'"'+t.replace(/"/g,'""')+'"':t}return{parse:s,parseRows:o,format:p,formatBody:m,formatRows:v,formatRow:r,formatValue:u}}var un=cn(","),pn=un.parse,mn=_('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p></section>');function gn(e){var n=mn();c(e,n)}var fn=_('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-o47y6s"/> <p>background image</p> <div class="svelte-o47y6s"></div></section>');function vn(e){var n=fn();c(e,n)}var yn=_('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function wn(e){const n=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var a=yn(),s=z(b(a),2);J(s,17,()=>n,q,(o,h)=>{let p=()=>i(h).tag,m=()=>i(h).text;var v=I(),r=T(v);de(r,p,!1,(u,t)=>{var l=$e();A(()=>C(l,m())),c(t,l)}),c(o,v)}),y(a),c(e,a)}var bn=_("<p> </p>");function zn(e,n){var a=bn(),s=b(a);y(a),A(()=>C(s,`I am component A and my favorite number is ${n.number??""}.`)),c(e,a)}var xn=_("<p> </p>");function _n(e,n){var a=xn(),s=b(a);y(a),A(()=>C(s,`I am component B and my name is ${n.name??""}.`)),c(e,a)}var Tn=_('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function Sn(e){const n={A:zn,B:_n},a=[{component:"A",number:42},{component:"B",name:"Russell"}];var s=Tn(),o=z(b(s),2);J(o,17,()=>a,q,(h,p)=>{const m=U(()=>n[i(p).component]);var v=I(),r=T(v);le(r,()=>i(m),(u,t)=>{t(u,he(()=>i(p)))}),c(h,v)}),y(s),c(e,s)}var kn=_('<div><p class="svelte-12sq0x6"> </p></div>'),Rn=_('<section id="scrolly"><h2 class="svelte-12sq0x6">Scrolly <span> </span></h2> <div class="spacer svelte-12sq0x6"></div> <!> <div class="spacer svelte-12sq0x6"></div></section>');function In(e){let n=W(void 0);var a=Rn(),s=b(a),o=z(b(s)),h=b(o,!0);y(o),y(s);var p=z(s,4);an(p,{get value(){return i(n)},set value(m){D(n,m,!0)},children:(m,v)=>{var r=I(),u=T(r);J(u,16,()=>[0,1,2,3,4],q,(t,l,f)=>{const g=U(()=>i(n)===f);var d=kn();let w;var x=b(d),S=b(x,!0);y(x),y(d),A(k=>{w=Ke(d,1,"step svelte-12sq0x6",null,w,k),C(S,l)},[()=>({active:i(g)})]),c(t,d)}),c(m,r)},$$slots:{default:!0}}),Ve(2),y(a),A(()=>C(h,i(n)||"-")),c(e,a)}const Cn=`{
  ...
  "sewingLessons": [
    ...
    {
      "type": "text",
      "value": "A few years ago, I started learning how to sew. Somehow it felt more practical to make my own clothes than count on meaningful change to happen on its own. Getting started was easier than I thought. Among the many thousands of sewing patterns, tutorials, and free online resources, I found a vibrant community of seamstresses and home sewists who were eager to share their skills. The first sewing pattern I ever completed — a boxy, drop-shoulder top that came in three variations as either a shirt or dress — was free to download. It included a 29-page instruction manual with photos and illustrations documenting every step."
    },
    {
      "type": "text",
...
}`;var An=_("<p><!></p>"),En=_("<section><!></section>");function Mn(e,n){Z(n,!0);let a=Y(n,"components",19,()=>({})),s=Y(n,"body",19,()=>[]);var o=I(),h=T(o);J(h,17,s,q,(p,m)=>{let v=()=>i(m).section,r=()=>i(m).content;const u=U(()=>v().toLowerCase().replace(/[^a-z0-9]/g,"")),t=U(()=>a()[v()]);var l=En(),f=b(l);{var g=w=>{var x=I(),S=T(x);le(S,()=>i(t),(k,M)=>{M(k,he(r))}),c(w,x)},d=w=>{var x=I(),S=T(x);J(S,17,r,q,(k,M,O,X)=>{let B=()=>i(M).type,E=()=>i(M).value;const ue=U(()=>a()[B()]),Ie=U(()=>typeof E()=="string");var pe=I(),Ce=T(pe);{var Ae=j=>{var $=I(),K=T($);le(K,()=>i(ue),(ee,ne)=>{ne(ee,he(E))}),c(j,$)},Ee=j=>{var $=I(),K=T($);{var ee=P=>{var L=An(),te=b(L);_e(te,E),y(L),c(P,L)},ne=P=>{var L=I(),te=T(L);{var Me=N=>{var V=I(),ae=T(V);de(ae,B,!1,(me,ge)=>{var fe=I(),De=T(fe);_e(De,E),c(ge,fe)}),c(N,V)},Be=N=>{var V=I(),ae=T(V);de(ae,B,!1,(me,ge)=>{nn(me,()=>({...E()}))}),c(N,V)};H(te,N=>{i(Ie)?N(Me):N(Be,!1)},!0)}c(P,L)};H(K,P=>{B()==="text"?P(ee):P(ne,!1)},!0)}c(j,$)};H(Ce,j=>{i(ue)?j(Ae):j(Ee,!1)})}c(k,pe)}),c(w,x)};H(f,w=>{i(t)?w(g):w(d,!1)})}y(l),A(()=>en(l,"id",i(u))),c(p,l)}),c(e,o),Q()}var Bn=_('<p> </p> <progress max="100"></progress>',1);function Dn(e,n){let a=Y(n,"label",3,"A"),s=Y(n,"value",3,0);var o=Bn(),h=T(o),p=b(h,!0);y(h);var m=z(h,2);A(()=>{C(p,a()),tn(m,s())}),c(e,o)}var Fn=_('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function Un(e,n){Z(n,!0);const{body:a}=sn,s={Test:Dn};var o=Fn(),h=z(b(o),2),p=b(h),m=b(p,!0);y(p),y(h);var v=z(h,2);Mn(v,{get components(){return s},get body(){return a}}),y(o),A(r=>C(m,r),[()=>Cn.replace(/\t/g," ")]),c(e,o),Q()}const Wn=(e,n=ke)=>{var a=jn(),s=b(a),o=b(s,!0);y(s);var h=z(s,2),p=b(h,!0);y(h),y(a),A(()=>{C(o,n().name),C(p,n().age)}),c(e,a)};var jn=_('<div class="person svelte-1ltx6da"><p class="svelte-1ltx6da"> </p> <p class="svelte-1ltx6da"> </p></div>'),Pn=(e,n)=>Ge(n),Ln=(e,n)=>n.random(Math.floor(Math.random()*10)),Nn=_('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-1ltx6da">count++</button> <p class="svelte-1ltx6da"> </p> <p class="svelte-1ltx6da"> </p> <p class="svelte-1ltx6da"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-1ltx6da">Random</button>  <h3>Snippets</h3> <div class="people svelte-1ltx6da"></div>',1);function Hn(e,n){Z(n,!0),Y(n,"age",3,30);const a=[{name:"John",age:30},{name:"Jill",age:45}];let s=W(0),o=U(()=>i(s)*2),h=U(()=>i(s)*2),p=W(0);ce(()=>{D(p,i(s)*2)});var m=Nn(),v=z(T(m),4);v.__click=[Pn,s];var r=z(v,2),u=b(r);y(r);var t=z(r,2),l=b(t);y(t);var f=z(t,2),g=b(f);y(f);var d=z(f,4),w=b(d);rn(w,()=>n.children??ke),y(d);var x=z(d,4);x.__click=[Ln,n];var S=z(x,4);J(S,21,()=>a,q,(k,M)=>{Wn(k,()=>i(M))}),y(S),A(()=>{C(u,`${i(s)??""} doubled is ${i(o)??""} (derived)`),C(l,`${i(s)??""} doubled is ${i(h)??""} (derived by)`),C(g,`${i(s)??""} doubled is ${i(p)??""} ($effect)`)}),c(e,m),Q()}Qe(["click"]);const Jn=(e,n)=>{let a=W(Ye(e)),s=W(null),o=W(!0),h=W(void 0);const p=(r=!0)=>{D(o,r,!0),r===!0&&(D(h,null),D(s,null))},m=async()=>{try{const r=await fetch(i(a),n);if(!r.ok)throw new Error(`Unexpected error occurred (status ${r.status})`);let u;if(i(a).includes(".csv")){const t=await r.text();u=pn(t)}else u=await r.json();return[null,u]}catch(r){const{errorMessage:u="Unexpected error eccurred"}=r;return[u,null]}},v=async r=>{p(!0);const[u,t]=await m();if(r===i(a)){if(u){p(!1),D(h,u,!0);return}p(!1),D(s,t,!0)}};return ce(()=>{v(i(a))}),{get data(){return i(s)},get loading(){return i(o)},get error(){return i(h)},get url(){return i(a)},set url(r){i(a)!==r&&D(a,r,!0)}}};var qn=_("<p>loading data...</p>"),On=_("<p> </p>"),Xn=_("<p>data loaded</p> <pre> </pre>",1),$n=_('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Vn(e,n){Z(n,!0);const a=`${on}/assets/demo/test.csv`,s=Jn(a);ce(()=>{});var o=$n(),h=z(b(o),2),p=b(h);{var m=r=>{var u=qn();c(r,u)},v=r=>{var u=I(),t=T(u);{var l=g=>{var d=On(),w=b(d);y(d),A(()=>C(w,`error: ${s.error??""}`)),c(g,d)},f=g=>{var d=Xn(),w=z(T(d),2),x=b(w,!0);y(w),A(S=>C(x,S),[()=>JSON.stringify(s.data,null,2)]),c(g,d)};H(t,g=>{s.error?g(l):g(f,!1)},!0)}c(r,u)};H(p,r=>{s.loading?r(m):r(v,!1)})}y(h),y(o),c(e,o),Q()}var Gn=_('<div id="demo" class="svelte-m1ilu3"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function Yn(e){let n=W(0);function a(l){console.log(l)}var s=Gn(),o=z(b(s),2);Hn(o,{random:a,get value(){return i(n)},set value(l){D(n,l,!0)}});var h=z(o,2);gn(h);var p=z(h,2);vn(p);var m=z(p,2);wn(m);var v=z(m,2);Sn(v);var r=z(v,2);Un(r,{});var u=z(r,2);Vn(u,{});var t=z(u,2);In(t),y(s),c(e,s)}function it(e){Yn(e)}export{it as component};

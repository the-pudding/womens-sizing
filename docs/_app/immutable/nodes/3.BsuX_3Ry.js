import"../chunks/Bzak7iHL.js";import{h as B,a as ve,f as se,aE as Be,b as je,E as qe,d as Ue,aF as Le,af as Pe,ad as Ne,c as We,a3 as ye,a2 as we,D as Oe,p as He,a5 as Je,ag as Xe,V as _,X as p,ax as z,Z as b,_ as y,ay as I,aw as T,aA as $e,W as A,A as o,az as j,C as F,av as q,aG as Ge,U as Z,Y as K,u as pe,aH as Ve,R as ke,B as Ye}from"../chunks/Dzm_WEGj.js";import{i as Ze,b as be,a as C,d as Ke}from"../chunks/ZgVi19R2.js";import{b as ze,c as xe,e as O,i as H,d as Qe,s as en,f as nn,g as tn}from"../chunks/CbB6GLjC.js";import{c as le}from"../chunks/DH1QYJyw.js";import{s as de,p as Y}from"../chunks/ihUrmXYw.js";import{S as an,h as _e,c as sn}from"../chunks/BAM0vvvk.js";import{i as W}from"../chunks/C0w0nz2X.js";import{s as rn}from"../chunks/BIhypZ3Q.js";import{b as on}from"../chunks/DiPc1BGi.js";function he(e,n,a,s,i,d){let c=B;B&&ve();var m,v,r=null;B&&se.nodeType===Be&&(r=se,ve());var u=B?se:e,t,l=xe;je(()=>{const f=n()||null;var g=f==="svg"?Le:null;if(f!==m){var h=xe;ze(l),t&&(f===null?He(t,()=>{t=null,v=null}):f===v?Je(t):(Xe(t),be(!1))),f&&f!==v&&(t=Ue(()=>{if(r=B?r:g?document.createElementNS(g,f):document.createElement(f),Pe(r,r),s){B&&Ze(f)&&r.append(document.createComment(""));var w=B?Ne(r):r.appendChild(We());B&&(w===null?ye(!1):we(w)),s(r,w)}Oe.nodes_end=r,u.before(r)})),m=f,m&&(v=m),be(!0),ze(h)}},qe),c&&(ye(!0),we(u))}var Te={},re={},ie=34,V=10,oe=13;function Re(e){return new Function("d","return {"+e.map(function(n,a){return JSON.stringify(n)+": d["+a+'] || ""'}).join(",")+"}")}function ln(e,n){var a=Re(e);return function(s,i){return n(a(s),i,e)}}function Se(e){var n=Object.create(null),a=[];return e.forEach(function(s){for(var i in s)i in n||a.push(n[i]=i)}),a}function R(e,n){var a=e+"",s=a.length;return s<n?new Array(n-s+1).join(0)+a:a}function dn(e){return e<0?"-"+R(-e,6):e>9999?"+"+R(e,6):R(e,4)}function hn(e){var n=e.getUTCHours(),a=e.getUTCMinutes(),s=e.getUTCSeconds(),i=e.getUTCMilliseconds();return isNaN(e)?"Invalid Date":dn(e.getUTCFullYear())+"-"+R(e.getUTCMonth()+1,2)+"-"+R(e.getUTCDate(),2)+(i?"T"+R(n,2)+":"+R(a,2)+":"+R(s,2)+"."+R(i,3)+"Z":s?"T"+R(n,2)+":"+R(a,2)+":"+R(s,2)+"Z":a||n?"T"+R(n,2)+":"+R(a,2)+"Z":"")}function pn(e){var n=new RegExp('["'+e+`
\r]`),a=e.charCodeAt(0);function s(t,l){var f,g,h=i(t,function(w,x){if(f)return f(w,x-1);g=w,f=l?ln(w,l):Re(w)});return h.columns=g||[],h}function i(t,l){var f=[],g=t.length,h=0,w=0,x,S=g<=0,k=!1;t.charCodeAt(g-1)===V&&--g,t.charCodeAt(g-1)===oe&&--g;function E(){if(S)return re;if(k)return k=!1,Te;var X,D=h,M;if(t.charCodeAt(D)===ie){for(;h++<g&&t.charCodeAt(h)!==ie||t.charCodeAt(++h)===ie;);return(X=h)>=g?S=!0:(M=t.charCodeAt(h++))===V?k=!0:M===oe&&(k=!0,t.charCodeAt(h)===V&&++h),t.slice(D+1,X-1).replace(/""/g,'"')}for(;h<g;){if((M=t.charCodeAt(X=h++))===V)k=!0;else if(M===oe)k=!0,t.charCodeAt(h)===V&&++h;else if(M!==a)continue;return t.slice(D,X)}return S=!0,t.slice(D,g)}for(;(x=E())!==re;){for(var J=[];x!==Te&&x!==re;)J.push(x),x=E();l&&(J=l(J,w++))==null||f.push(J)}return f}function d(t,l){return t.map(function(f){return l.map(function(g){return u(f[g])}).join(e)})}function c(t,l){return l==null&&(l=Se(t)),[l.map(u).join(e)].concat(d(t,l)).join(`
`)}function m(t,l){return l==null&&(l=Se(t)),d(t,l).join(`
`)}function v(t){return t.map(r).join(`
`)}function r(t){return t.map(u).join(e)}function u(t){return t==null?"":t instanceof Date?hn(t):n.test(t+="")?'"'+t.replace(/"/g,'""')+'"':t}return{parse:s,parseRows:i,format:c,formatBody:m,formatRows:v,formatRow:r,formatValue:u}}var un=pn(","),cn=un.parse,mn=_('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p></section>');function gn(e){var n=mn();p(e,n)}var fn=_('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-o47y6s"/> <p>background image</p> <div class="svelte-o47y6s"></div></section>');function vn(e){var n=fn();p(e,n)}var yn=_('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function wn(e){const n=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var a=yn(),s=z(b(a),2);O(s,17,()=>n,H,(i,d)=>{let c=()=>o(d).tag,m=()=>o(d).text;var v=I(),r=T(v);he(r,c,!1,(u,t)=>{var l=$e();A(()=>C(l,m())),p(t,l)}),p(i,v)}),y(a),p(e,a)}var bn=_("<p> </p>");function zn(e,n){var a=bn(),s=b(a);y(a),A(()=>C(s,`I am component A and my favorite number is ${n.number??""}.`)),p(e,a)}var xn=_("<p> </p>");function _n(e,n){var a=xn(),s=b(a);y(a),A(()=>C(s,`I am component B and my name is ${n.name??""}.`)),p(e,a)}var Tn=_('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function Sn(e){const n={A:zn,B:_n},a=[{component:"A",number:42},{component:"B",name:"Russell"}];var s=Tn(),i=z(b(s),2);O(i,17,()=>a,H,(d,c)=>{const m=j(()=>n[o(c).component]);var v=I(),r=T(v);le(r,()=>o(m),(u,t)=>{t(u,de(()=>o(c)))}),p(d,v)}),y(s),p(e,s)}var kn=_('<div><p class="svelte-12sq0x6"> </p></div>'),Rn=_('<section id="scrolly"><h2 class="svelte-12sq0x6">Scrolly <span> </span></h2> <div class="spacer svelte-12sq0x6"></div> <!> <div class="spacer svelte-12sq0x6"></div></section>');function In(e){let n=q(void 0);var a=Rn(),s=b(a),i=z(b(s)),d=b(i,!0);y(i),y(s);var c=z(s,4);an(c,{get value(){return o(n)},set value(m){F(n,m,!0)},children:(m,v)=>{var r=I(),u=T(r);O(u,16,()=>[0,1,2,3,4],H,(t,l,f)=>{const g=j(()=>o(n)===f);var h=kn();let w;var x=b(h),S=b(x,!0);y(x),y(h),A(k=>{w=Qe(h,1,"step svelte-12sq0x6",null,w,k),C(S,l)},[()=>({active:o(g)})]),p(t,h)}),p(m,r)},$$slots:{default:!0}}),Ge(2),y(a),A(()=>C(d,o(n)||"-")),p(e,a)}const Cn=`{
  ...
  "introScroll": [
    ...
    },
    {
      ...
      "sizeRange": "Junior's",
      "sizeType": "alphaSize",
      "text": "But not all tweens wear the same size.\\r\\n\\r\\n\\r\\nIf we were to look at a sample of all <span class=bold>10- and 11-year-old girls</span> in the U.S. from the <a href=https://stacks.cdc.gov/view/cdc/174595> National Center for Health Statistics,</a> here are the junior’s sizes that match up with their body measurements."
    },
    {
      "id": "3",
      "start": "4",
  ...
  "sewingLessons": [
    ...
    {
      "type": "text",
      "value": "I, like the vast majority of women, do not fit the standard mold. Instead I took an old pattern-making textbook often taught in fashion design schools to start making clothes to fit my own unique proportions. I gathered and recorded over 58 different body measurements in order to get started and from there, I could make my own custom base pattern, known as a bodice block or sloper."
    },
    {
      "type": "text",
...
}`;var An=_("<p><!></p>"),Mn=_("<section><!></section>");function En(e,n){Z(n,!0);let a=Y(n,"components",19,()=>({})),s=Y(n,"body",19,()=>[]);var i=I(),d=T(i);O(d,17,s,H,(c,m)=>{let v=()=>o(m).section,r=()=>o(m).content;const u=j(()=>v().toLowerCase().replace(/[^a-z0-9]/g,"")),t=j(()=>a()[v()]);var l=Mn(),f=b(l);{var g=w=>{var x=I(),S=T(x);le(S,()=>o(t),(k,E)=>{E(k,de(r))}),p(w,x)},h=w=>{var x=I(),S=T(x);O(S,17,r,H,(k,E,J,X)=>{let D=()=>o(E).type,M=()=>o(E).value;const ue=j(()=>a()[D()]),Ie=j(()=>typeof M()=="string");var ce=I(),Ce=T(ce);{var Ae=U=>{var $=I(),Q=T($);le(Q,()=>o(ue),(ee,ne)=>{ne(ee,de(M))}),p(U,$)},Me=U=>{var $=I(),Q=T($);{var ee=L=>{var P=An(),te=b(P);_e(te,M),y(P),p(L,P)},ne=L=>{var P=I(),te=T(P);{var Ee=N=>{var G=I(),ae=T(G);he(ae,D,!1,(me,ge)=>{var fe=I(),Fe=T(fe);_e(Fe,M),p(ge,fe)}),p(N,G)},De=N=>{var G=I(),ae=T(G);he(ae,D,!1,(me,ge)=>{nn(me,()=>({...M()}))}),p(N,G)};W(te,N=>{o(Ie)?N(Ee):N(De,!1)},!0)}p(L,P)};W(Q,L=>{D()==="text"?L(ee):L(ne,!1)},!0)}p(U,$)};W(Ce,U=>{o(ue)?U(Ae):U(Me,!1)})}p(k,ce)}),p(w,x)};W(f,w=>{o(t)?w(g):w(h,!1)})}y(l),A(()=>en(l,"id",o(u))),p(c,l)}),p(e,i),K()}var Dn=_('<p> </p> <progress max="100"></progress>',1);function Fn(e,n){let a=Y(n,"label",3,"A"),s=Y(n,"value",3,0);var i=Dn(),d=T(i),c=b(d,!0);y(d);var m=z(d,2);A(()=>{C(c,a()),tn(m,s())}),p(e,i)}var Bn=_('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function jn(e,n){Z(n,!0);const{body:a}=sn,s={Test:Fn};var i=Bn(),d=z(b(i),2),c=b(d),m=b(c,!0);y(c),y(d);var v=z(d,2);En(v,{get components(){return s},get body(){return a}}),y(i),A(r=>C(m,r),[()=>Cn.replace(/\t/g," ")]),p(e,i),K()}const qn=(e,n=ke)=>{var a=Un(),s=b(a),i=b(s,!0);y(s);var d=z(s,2),c=b(d,!0);y(d),y(a),A(()=>{C(i,n().name),C(c,n().age)}),p(e,a)};var Un=_('<div class="person svelte-1ltx6da"><p class="svelte-1ltx6da"> </p> <p class="svelte-1ltx6da"> </p></div>'),Ln=(e,n)=>Ve(n),Pn=(e,n)=>n.random(Math.floor(Math.random()*10)),Nn=_('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-1ltx6da">count++</button> <p class="svelte-1ltx6da"> </p> <p class="svelte-1ltx6da"> </p> <p class="svelte-1ltx6da"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-1ltx6da">Random</button>  <h3>Snippets</h3> <div class="people svelte-1ltx6da"></div>',1);function Wn(e,n){Z(n,!0),Y(n,"age",3,30);const a=[{name:"John",age:30},{name:"Jill",age:45}];let s=q(0),i=j(()=>o(s)*2),d=j(()=>o(s)*2),c=q(0);pe(()=>{F(c,o(s)*2)});var m=Nn(),v=z(T(m),4);v.__click=[Ln,s];var r=z(v,2),u=b(r);y(r);var t=z(r,2),l=b(t);y(t);var f=z(t,2),g=b(f);y(f);var h=z(f,4),w=b(h);rn(w,()=>n.children??ke),y(h);var x=z(h,4);x.__click=[Pn,n];var S=z(x,4);O(S,21,()=>a,H,(k,E)=>{qn(k,()=>o(E))}),y(S),A(()=>{C(u,`${o(s)??""} doubled is ${o(i)??""} (derived)`),C(l,`${o(s)??""} doubled is ${o(d)??""} (derived by)`),C(g,`${o(s)??""} doubled is ${o(c)??""} ($effect)`)}),p(e,m),K()}Ke(["click"]);const On=(e,n)=>{let a=q(Ye(e)),s=q(null),i=q(!0),d=q(void 0);const c=(r=!0)=>{F(i,r,!0),r===!0&&(F(d,null),F(s,null))},m=async()=>{try{const r=await fetch(o(a),n);if(!r.ok)throw new Error(`Unexpected error occurred (status ${r.status})`);let u;if(o(a).includes(".csv")){const t=await r.text();u=cn(t)}else u=await r.json();return[null,u]}catch(r){const{errorMessage:u="Unexpected error eccurred"}=r;return[u,null]}},v=async r=>{c(!0);const[u,t]=await m();if(r===o(a)){if(u){c(!1),F(d,u,!0);return}c(!1),F(s,t,!0)}};return pe(()=>{v(o(a))}),{get data(){return o(s)},get loading(){return o(i)},get error(){return o(d)},get url(){return o(a)},set url(r){o(a)!==r&&F(a,r,!0)}}};var Hn=_("<p>loading data...</p>"),Jn=_("<p> </p>"),Xn=_("<p>data loaded</p> <pre> </pre>",1),$n=_('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Gn(e,n){Z(n,!0);const a=`${on}/assets/demo/test.csv`,s=On(a);pe(()=>{});var i=$n(),d=z(b(i),2),c=b(d);{var m=r=>{var u=Hn();p(r,u)},v=r=>{var u=I(),t=T(u);{var l=g=>{var h=Jn(),w=b(h);y(h),A(()=>C(w,`error: ${s.error??""}`)),p(g,h)},f=g=>{var h=Xn(),w=z(T(h),2),x=b(w,!0);y(w),A(S=>C(x,S),[()=>JSON.stringify(s.data,null,2)]),p(g,h)};W(t,g=>{s.error?g(l):g(f,!1)},!0)}p(r,u)};W(c,r=>{s.loading?r(m):r(v,!1)})}y(d),y(i),p(e,i),K()}var Vn=_('<div id="demo" class="svelte-m1ilu3"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function Yn(e){let n=q(0);function a(l){console.log(l)}var s=Vn(),i=z(b(s),2);Wn(i,{random:a,get value(){return o(n)},set value(l){F(n,l,!0)}});var d=z(i,2);gn(d);var c=z(d,2);vn(c);var m=z(c,2);wn(m);var v=z(m,2);Sn(v);var r=z(v,2);jn(r,{});var u=z(r,2);Gn(u,{});var t=z(u,2);In(t),y(s),p(e,s)}function ot(e){Yn(e)}export{ot as component};
